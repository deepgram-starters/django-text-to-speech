# Django Text-to-Speech Starter

[![Discord](https://dcbadge.vercel.app/api/server/xWRaCDBtW4?style=flat)](https://discord.gg/xWRaCDBtW4)

This sample demonstrates interacting with the Deepgram API from Django to convert text to speech. It uses the Deepgram Python SDK with a frontend built from web components.
...
git clone https://github.com/deepgram-starters/django-text-to-speech.git
...
This project uses:
- **Backend**: Django (standard project structure)
...
- [Open an issue in this repository](https://github.com/deepgram-starters/django-text-to-speech/issues/new)
